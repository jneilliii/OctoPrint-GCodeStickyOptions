...
plugin_identifier = "gcodestickyoptions"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_gcodestickyoptions"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "GCode Sticky Options"
...
# module
plugin_description = """Simple plugin to save the checked options in the GCode Viewer tab."""
...
plugin_url = "https://github.com/jneilliii/OctoPrint-GCodeStickyOptions"
